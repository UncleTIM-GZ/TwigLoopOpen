...
class CreateTaskCardRequest(BaseModel):
    ...
    # EWU is set exclusively via the calculate-ewu endpoint; defaults to 1.0 at creation.
...
class UpdateTaskCardRequest(BaseModel):
    ...
    # EWU cannot be updated directly; use the calculate-ewu endpoint instead.
