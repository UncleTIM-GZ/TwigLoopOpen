...
const NAV_LINKS = [
  ...
  { href: "/public-benefit/apply", label: "Public Benefit" },
...
export function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-gray-800/50 px-6 py-3 flex items-center justify-between bg-gray-950/80 backdrop-blur-md">
